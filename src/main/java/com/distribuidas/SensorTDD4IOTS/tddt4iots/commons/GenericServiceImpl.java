package com.distribuidas.SensorTDD4IOTS.tddt4iots.commons;
...
public abstract class GenericServiceImpl<I, O> implements GenericServiceAPI<I, O> {
	...
	public O get(String id) throws Exception {
		...
		if (document.exists()) {
			...
			//Object object2 = document.toObject(clazz);

			//Object objectWithoutId = document.toObject(clazz);
			//PropertyUtils.setProperty(object, "id", null);
